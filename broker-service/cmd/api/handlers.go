...
func (app *Config) authenticate(w http.ResponseWriter, a AuthPayload) {
	...
	// make sure we get back the status code
...
func (app *Config) logEventViaRabbitMQ(w http.ResponseWriter, log LoggerPayload) {
...
func (app *Config) logEventViaRPC(w http.ResponseWriter, log LoggerPayload) {
...
func (app *Config) pushToQueue(name, msg string) error {
	producer, err := event.NewEventProducer(app.RabbitConn)
	if err != nil {
		return err
	}
